...
4. Open Mind Miles. It will say "Every tab" instead of "This tab only".
...
this extension and no server for one to reach. When you open Mind Miles,
`bridge.js` hands the totals to the page. That is the only way data leaves, and
it only ever goes to the Mind Miles page on the same computer.

## Removing it

Uninstalling deletes everything it stored. Mind Miles goes back to counting only
